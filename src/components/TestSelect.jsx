...
const TestSelect = ({ grade, setTest }) => {
    ...
    const getTest = async () => {
      try {
        ...
        if (response.success === true) {
          ...
          // Handle the case when the test is not available
          setErrors(["This test is not available at this time"]);
          setOpenDialog(true);
        }
      } catch (error) {
        console.log(error);
        // Set errors state to show in the dialog
  ...
  }, [testSub, grade, setTest, navigate]);
  return (
      ...
      <Grid item xs={12} sm={4}>
        ...
        >
          ...
          <CardContent sx={{ flexGrow: 1 }}>
            ...
            <Typography>
              "Math challenge ahead! 🚀 Dive in, tackle puzzles, and enjoy the
              journey of numbers. Good luck! 🧮✨"
            </Typography>
          </CardContent>
          <CardActions>
            <Button
      ...
      <Grid item xs={12} sm={4}>
        ...
        >
          ...
          <CardContent sx={{ flexGrow: 1 }}>
            ...
            <Typography>
              "Science exploration awaits! 🌌 Unravel the mysteries, embark on
              experiments, and unleash your inner scientist. Dive in! 🔬🌟"
            </Typography>
          </CardContent>
          <CardActions>
            <Button
      ...
      <Grid item xs={12} sm={4}>
        ...
        >
          ...
          <CardContent sx={{ flexGrow: 1 }}>
            ...
            <Typography>
              "Embark on literary adventures! 📚 Dive into tales, traverse
              through narratives, and sharpen your comprehension. Happy reading!
              🌍📖"
            </Typography>
          </CardContent>
          <CardActions>
